        ...
        <div class="box gradient">
			<div class="widget-title">
				...
				<thead>
					...
					<?php
						$q1 = mysql_query("SELECT u.id_user, u.nama, SUM(p.jumlah) as jumlah
						...
						while($p1 = mysql_fetch_array($q1)){
							$sq = mysql_query("SELECT tanggal FROM penyaluran WHERE is_ukm='1' AND id_ukm='$p1[id_user]'  AND th_kubah='$_GET[th]' ORDER BY tanggal DESC");
							$tgl1 = mysql_fetch_array($sq);
							$t = explode('-',$tgl1['tanggal']);
							$q2 = mysql_query("SELECT SUM(jumlah) as jumlah FROM penerimaan WHERE id_donatur = '$p1[id_user]' AND th_kubah='$_GET[th]'");
