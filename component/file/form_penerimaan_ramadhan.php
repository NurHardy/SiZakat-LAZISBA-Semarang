      ...
      <div class="widget-box">
        <div class="box gradient">
          <div class="widget-title">
            <h5>
            <i class="icon-book"></i><span>Tambah Transaksi Penerimaan Ramadhan</span>
            </h5>
          </div>
          <div class="widget-content nopadding">
            <form class="form-horizontal row-fluid" action="component/server/func_input_penerimaan_ramadhan.php" Method="POST">
			   ...
			   <div class="form-row control-group row-fluid form-group">
                ...
                <div class="controls span5">
					<select name='trans' class="input-small" style='width:80%;' required='required' data-placeholder="-- Pilih Transaksi --">
						<option></option>
					<?php
						$q1 = mysqli_query($mysqli, "SELECT * FROM akun WHERE jenis = '3' AND idParent != '0'  AND idakun NOT IN (SELECT idParent FROM akun)");
			...
			<div class="form-actions">
                  <button type="submit" name='save' class="btn btn-primary btn-small"><?php echo ($_GET['s'] == 'penerimaan_ramadhan')?"Tambah Transaksi":"Ubah Transaksi";?></button>
			</div>
