          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal row-fluid" action="component/server/func_input_penerimaan.php" Method="POST" onsubmit="return validateData()">
			  ...
			  <div class="form-row control-group row-fluid form-group">
                ...
                <div class="controls span5">
				  ...
				  value="<?php echo $trxData['tanggal'];?>" class="datepicker form-control input-small span5" name='tanggal' value='' style='width:80%;'/>
                </div>
              </div>
			  ...
			  <div class="form-row control-group row-fluid form-group" id="field_nota" style="display:block;">
                ...
                <div class="controls span5">
                  <input type="text" id="siz-penerimaan-nota" class="form-control input-small"
				    name="notrans" required
			  ...
			  <div class="form-row control-group row-fluid form-group" id="field_jumlah_set" style="display:block;">
                ...
                <div class="controls span5">
                  <input type="text" id="normal-field number" class="form-control input-small"
					name="jumlah" required='required' style='width:80%;'
					pattern="[0-9]" value="<?php echo intval($trxData['jumlah']); ?>"/>
                </div>
              </div>
			...
			<div class="form-actions" style="display:block;">
                  <button type="submit" name='save' class="btn btn-primary btn-small">
					...
					<?php echo ($isEditing?
						"<span class=\"glyphicon glyphicon-pencil\"></span> Ubah Transaksi":
						"<span class=\"glyphicon glyphicon-plus\"></span> Tambah Transaksi");?></button>
			</div>
