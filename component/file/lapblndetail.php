		...
		<div class="widget-content nopadding">
			<div style='padding:10px;'>
				<div class="widget-box">
					...
					<?php
						$queryLaporanKas = "SELECT * FROM (SELECT no_nota, tanggal, jumlah, keterangan, '1' AS tran, (SELECT namaakun FROM akun WHERE penerimaan.id_akun = akun.kode) AS namaakun, (SELECT nama FROM user WHERE penerimaan.id_donatur=user.id_user) AS nama, (SELECT alamat FROM user WHERE penerimaan.id_donatur=user.id_user) AS alamat, (SELECT nama FROM user WHERE penerimaan.id_teller=user.id_user) AS amilin FROM penerimaan 
						UNION ALL 
